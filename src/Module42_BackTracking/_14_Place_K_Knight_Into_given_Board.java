...
//its print all the possible chessboard that have N number of Knight in the given chess board note n*n>no of knight
public class _14_Place_K_Knight_Into_given_Board {
    static int maxKnight = -1;
    static int number = 5;//No of Knight
